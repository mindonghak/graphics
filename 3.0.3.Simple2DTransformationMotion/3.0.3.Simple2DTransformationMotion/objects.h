...
#define ROAD_LEFT_TREE 0
#define ROAD_LEFT_LEAF 1
#define ROAD_RIGHT_TREE 2
#define ROAD_RIGHT_LEAF 3
#define ROAD_HALFLINE 4
#define ROAD_LEFT_APPLE 5
#define ROAD_GRASS 6

GLfloat road_left_tree[6][2] = { {-205 , 10}, {-200, 40}, { -190, 40}, {-185, 10}, {-180, 0}, {-210, 0} };
GLfloat road_left_leaf[10][2] = { {-200, 40}, {-220, 50}, {-220, 60}, {-210, 70}, {-200, 80}, {-190, 80}, {-180, 70}, {-170, 60}, {-170, 50}, {-190, 40} };
GLfloat road_right_tree[6][2] = { {205, 10}, { 200, 40}, { 190, 40},{185, 10}, {180, 0}, {210, 0} };
GLfloat road_right_leaf[10][2] = { {200, 40}, {220, 50}, {220, 60}, {210, 70}, {200, 80}, {190, 80}, {180, 70}, {170, 60}, {170, 50}, {190, 40} };
GLfloat road_halfline[4][2] = { {-10,0}, {-5, 60}, {5, 60}, {10, 0} };
GLfloat road_left_apple[8][2] = { {-198, 52}, {-198,55}, {-195, 58}, {-190,58}, {-187, 55}, {-187, 52}, {-190,50}, {-195,50} };
GLfloat road_grass[7][2] = { {220, 0 }, {220, 20}, {225, 5}, {230, 20}, {235, 5}, {240, 20},{240, 0} };


GLfloat road_color[7][3] = {
	{ 150 / 255.0f, 75 / 255.0f, 0 / 255.0f},
	{ 0 / 255.0f, 128 / 255.0f, 0 / 255.0f},
	{ 150 / 255.0f, 75 / 255.0f, 0 / 255.0f},
	{ 0 / 255.0f, 128 / 255.0f, 0 / 255.0f},
	{ 0 / 255.0f, 0 / 255.0f, 0 / 255.0f},
	{ 255 / 255.0f, 0 / 255.0f, 0 / 255.0f},
	{ 124 / 255.0f, 250 / 255.0f, 0 / 255.0f}
};

GLuint VBO_road, VAO_road;

void prepare_road() {
	GLsizeiptr buffer_size = sizeof(road_left_tree) + sizeof(road_left_leaf) + sizeof(road_right_tree) + sizeof(road_right_leaf) + sizeof(road_halfline) + sizeof(road_left_apple) + sizeof(road_grass);
	...
	glBufferSubData(GL_ARRAY_BUFFER, 0, sizeof(road_left_tree), road_left_tree);
	glBufferSubData(GL_ARRAY_BUFFER, sizeof(road_left_tree), sizeof(road_left_leaf), road_left_leaf);
	glBufferSubData(GL_ARRAY_BUFFER, sizeof(road_left_tree) + sizeof(road_left_leaf), sizeof(road_right_tree), road_right_tree);
	glBufferSubData(GL_ARRAY_BUFFER, sizeof(road_left_tree) + sizeof(road_left_leaf) + sizeof(road_right_tree), sizeof(road_right_leaf), road_right_leaf);
	glBufferSubData(GL_ARRAY_BUFFER, sizeof(road_left_tree) + sizeof(road_left_leaf) + sizeof(road_right_tree) + sizeof(road_right_leaf), sizeof(road_halfline), road_halfline);
	glBufferSubData(GL_ARRAY_BUFFER, sizeof(road_left_tree) + sizeof(road_left_leaf) + sizeof(road_right_tree) + sizeof(road_right_leaf) + sizeof(road_halfline), sizeof(road_left_apple), road_left_apple);
	glBufferSubData(GL_ARRAY_BUFFER, sizeof(road_left_tree) + sizeof(road_left_leaf) + sizeof(road_right_tree) + sizeof(road_right_leaf) + sizeof(road_halfline) + sizeof(road_left_apple), sizeof(road_grass), road_grass);
...
void draw_road() {
	...
	glUniform3fv(loc_primitive_color, 1, road_color[ROAD_LEFT_TREE]);
	glDrawArrays(GL_TRIANGLE_FAN, 0, 6);
	glUniform3fv(loc_primitive_color, 1, road_color[ROAD_LEFT_LEAF]);
	glDrawArrays(GL_TRIANGLE_FAN, 6, 10);
	glUniform3fv(loc_primitive_color, 1, road_color[ROAD_RIGHT_TREE]);
	glDrawArrays(GL_TRIANGLE_FAN, 16, 6);
	glUniform3fv(loc_primitive_color, 1, road_color[ROAD_RIGHT_LEAF]);
	glDrawArrays(GL_TRIANGLE_FAN, 22, 10);
	glUniform3fv(loc_primitive_color, 1, road_color[ROAD_HALFLINE]);
	glDrawArrays(GL_TRIANGLE_FAN, 32, 4);
	glUniform3fv(loc_primitive_color, 1, road_color[ROAD_LEFT_APPLE]);
	glDrawArrays(GL_TRIANGLE_FAN, 36, 8);
	glUniform3fv(loc_primitive_color, 1, road_color[ROAD_GRASS]);
...
GLfloat cake1_fire[4][2] = { { -0.5, 14.0 },{ -0.5, 13.0 },{ 0.0, 13.0 },{ 0.0, 14.0 } };
GLfloat cake1_candle[4][2] = { { -1.0, 8.0 } ,{ -1.0, 13.0 },{ 0.0, 13.0 },{ 0.0, 8.0 } };
GLfloat cake1_body[4][2] = { { 0.0, 5.0 },{ -8.0, 5.0 } ,{ -8.0, 8.0 },{ 0.0, 8.0 } };
GLfloat cake1_bottom[4][2] = { { -10.0, 1.0 },{ -10.0, 5.0 },{ 0.0, 5.0 },{ 0.0, 1.0 } };
GLfloat cake1_decorate[4][2] = { { -10.0, 0.0 },{ -10.0, 1.0 },{ 0.0, 1.0 },{ 0.0, 0.0 } };

GLfloat cake1_color[5][3] = {
	{ 255 / 255.0f, 0 / 255.0f, 0 / 255.0f },
{ 255 / 255.0f, 204 / 255.0f, 0 / 255.0f },
{ 255 / 255.0f, 102 / 255.0f, 255 / 255.0f },
{ 255 / 255.0f, 102 / 255.0f, 255 / 255.0f },
...
GLuint VBO_cake1, VAO_cake1;

void prepare_cake1() {
	int size = sizeof(cake1_fire);
	GLsizeiptr buffer_size = sizeof(cake1_fire) * 5;

	// Initialize vertex buffer object.
	glGenBuffers(1, &VBO_cake1);

	glBindBuffer(GL_ARRAY_BUFFER, VBO_cake1);
	glBufferData(GL_ARRAY_BUFFER, buffer_size, NULL, GL_STATIC_DRAW); // allocate buffer object memory

	glBufferSubData(GL_ARRAY_BUFFER, 0, size, cake1_fire);
	glBufferSubData(GL_ARRAY_BUFFER, size, size, cake1_candle);
	glBufferSubData(GL_ARRAY_BUFFER, size * 2, size, cake1_body);
	glBufferSubData(GL_ARRAY_BUFFER, size * 3, size, cake1_bottom);
	glBufferSubData(GL_ARRAY_BUFFER, size * 4, size, cake1_decorate);

	// Initialize vertex array object.
	glGenVertexArrays(1, &VAO_cake1);
	glBindVertexArray(VAO_cake1);
...
void draw_cake1() {
	...
	glUniform3fv(loc_primitive_color, 1, cake1_color[CAKE_FIRE]);
	glDrawArrays(GL_TRIANGLE_FAN, 0, 4);

	glUniform3fv(loc_primitive_color, 1, cake1_color[CAKE_CANDLE]);
	glDrawArrays(GL_TRIANGLE_FAN, 4, 4);

	glUniform3fv(loc_primitive_color, 1, cake1_color[CAKE_BODY]);
	glDrawArrays(GL_TRIANGLE_FAN, 8, 4);

	glUniform3fv(loc_primitive_color, 1, cake1_color[CAKE_BOTTOM]);
	glDrawArrays(GL_TRIANGLE_FAN, 12, 4);

	glUniform3fv(loc_primitive_color, 1, cake1_color[CAKE_DECORATE]);
	glDrawArrays(GL_TRIANGLE_FAN, 16, 4);
...
GLfloat cake2_fire[4][2] = { { 0.0, 14.0 },{ 0.0, 13.0 },{ 0.5, 13.0 },{ 0.5, 14.0 } };
GLfloat cake2_candle[4][2] = { { 0.0, 8.0 } ,{ 0.0, 13.0 },{ 1.0, 13.0 },{ 1.0, 8.0 } };
GLfloat cake2_body[4][2] = { { 8.0, 5.0 },{ 0.0, 5.0 } ,{ 0.0, 8.0 },{ 8.0, 8.0 } };
GLfloat cake2_bottom[4][2] = { { 0.0, 1.0 },{ 0.0, 5.0 },{ 10.0, 5.0 },{ 10.0, 1.0 } };
GLfloat cake2_decorate[4][2] = { { 0.0, 0.0 },{ 0.0, 1.0 },{ 10.0, 1.0 },{ 10.0, 0.0 } };
...
GLuint VBO_cake2, VAO_cake2;

void prepare_cake2() {
	int size = sizeof(cake2_fire);
	GLsizeiptr buffer_size = sizeof(cake2_fire) * 5;

	// Initialize vertex buffer object.
	glGenBuffers(1, &VBO_cake2);

	glBindBuffer(GL_ARRAY_BUFFER, VBO_cake2);
	glBufferData(GL_ARRAY_BUFFER, buffer_size, NULL, GL_STATIC_DRAW); // allocate buffer object memory

	glBufferSubData(GL_ARRAY_BUFFER, 0, size, cake2_fire);
	glBufferSubData(GL_ARRAY_BUFFER, size, size, cake2_candle);
	glBufferSubData(GL_ARRAY_BUFFER, size * 2, size, cake2_body);
	glBufferSubData(GL_ARRAY_BUFFER, size * 3, size, cake2_bottom);
	glBufferSubData(GL_ARRAY_BUFFER, size * 4, size, cake2_decorate);

	// Initialize vertex array object.
	glGenVertexArrays(1, &VAO_cake2);
	glBindVertexArray(VAO_cake2);
